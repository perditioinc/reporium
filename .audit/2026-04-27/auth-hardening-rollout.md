...
The third account is the canonical "you" path — sign in with `***REDACTED-OPERATOR-EMAIL***` if that GitHub account has active perditioinc membership; otherwise use any account that does.
